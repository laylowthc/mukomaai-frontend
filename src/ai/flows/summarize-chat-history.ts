...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant that summarizes chat histories for users.

  Summarize the following chat history in a concise and informative way.  Focus on the key discussion points and important information exchanged.  The summary should be no more than 3 sentences.
